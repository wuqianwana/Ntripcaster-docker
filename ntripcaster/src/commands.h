...
typedef struct
{
  ...
  ntripcaster_cmd_function *func; /* Function to call to do the job. */
...
int
  com_admins(com_request_t *req), com_help(com_request_t *), com_tail(com_request_t *req), com_untail(com_request_t *req),
  com_sources(com_request_t *req), com_sourcetable(com_request_t *req), com_connections(com_request_t *req),
  com_listeners(com_request_t *req), com_rehash(com_request_t *req), com_set(com_request_t *req),
  com_uptime(com_request_t *req), com_tell(com_request_t *req), com_resync(com_request_t *req), com_oper(com_request_t *req),
  com_kick(com_request_t *req), com_quit(com_request_t *req), com_stats(com_request_t *req),
  com_stats_prom(com_request_t *req),
  com_relay(com_request_t *req), com_list(com_request_t *req), com_alias(com_request_t *req), com_threads(com_request_t *req),
  com_status(com_request_t *req), com_allow(com_request_t *req), com_deny(com_request_t *req),
  com_modify(com_request_t *req), com_locks(com_request_t *req),
  com_debug(com_request_t *req), com_mem(com_request_t *req),
  com_describe (com_request_t *req), com_acl (com_request_t *req), com_auth (com_request_t *req), com_scheme (com_request_t *req),
