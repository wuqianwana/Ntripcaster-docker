...
const char *http_odd (char *command, connection_t *clicon, connection_t *sourcecon, const char *ptr, int fd, vartree_t *variables);
const char *http_even (char *command, connection_t *clicon, connection_t *sourcecon, const char *ptr, int fd, vartree_t *variables);
const char *http_include (char *command, connection_t *clicon, connection_t *sourcecon, const char *ptr, int fd, vartree_t *variables);
const char *http_foreach (char *command, connection_t *clicon, connection_t *sourcecon, const char *ptr, int fd, vartree_t *variables);
#endif
